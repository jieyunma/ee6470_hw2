...
int sc_main(int argc, char **argv) {
  ...
  sc_fifo<unsigned char> r;  // sc_fifo<unsigned char> r (256);
  sc_fifo<unsigned char> g;  // sc_fifo<unsigned char> g (256);
  sc_fifo<unsigned char> b;  // sc_fifo<unsigned char> b (256);
